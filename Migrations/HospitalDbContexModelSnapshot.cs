...
namespace Task9.Migrations
{
    ...
    partial class HospitalDbContexModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("Task9.Entities.Prescription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DueDate = new DateTime(2023, 6, 7, 20, 41, 52, 764, DateTimeKind.Utc).AddTicks(311),
                            IdDoctor = 1,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DueDate = new DateTime(2023, 6, 7, 20, 41, 52, 764, DateTimeKind.Utc).AddTicks(318),
                            IdDoctor = 3,
                            IdPatient = 1
                        });
                });

            modelBuilder.Entity("Task9.Entities.User", b =>
                {
